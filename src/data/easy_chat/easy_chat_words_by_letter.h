...
// In the vanilla game, this sentinel is primarily used for Pokemon that appear 
// in both the "local" and "national" categories. However, it's actually meant 
// for any word that appears in multiple groups. For example, "PSYCHIC" is both 
// the name of a move and the name of a type, so two separate EC words, which 
// are in different groups, have identical text content and so get marked with 
// this sentinel.
