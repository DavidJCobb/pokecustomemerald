...
static void DecompressGlyph_Bold(u16 glyphId, bool32 isJapanese)
{
    const u16 *glyphs;
    ...
    {
        glyphs = gFontBoldLatinGlyphs + (0x20 * glyphId);
        gCurGlyph.width = gFontBoldLatinGlyphWidths[glyphId];
