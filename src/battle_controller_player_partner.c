...
static void PlayerPartnerHandleReportStatChange(void);
...
static void (*const sPlayerPartnerBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_REPORTSTATCHANGE]         = PlayerPartnerHandleReportStatChange,
...
static void PlayerPartnerHandleReturnMonToBall(void) {
   BtlController_HandleReturnMonToBall(PlayerPartnerBufferExecCompleted);
}
...
static void PlayerPartnerHandleMoveAnimation(void) {
   BtlController_HandleMoveAnimation(PlayerPartnerBufferExecCompleted);
}

static void PlayerPartnerHandlePrintString(void) {
   BtlController_HandlePrintString(PlayerPartnerBufferExecCompleted);
}
...
static void PlayerPartnerHandleHealthBarUpdate_CustomComplete(void) {
   HandleLowHpMusicChange(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], gActiveBattler);
   PlayerPartnerBufferExecCompleted();
}
static void PlayerPartnerHandleHealthBarUpdate(void) {
   ...
   //
   BtlController_HandleHealthBarUpdate(PlayerPartnerHandleHealthBarUpdate_CustomComplete);
}
...
static void PlayerPartnerHandleStatusIconUpdate(void) {
   BtlController_HandleStatusIconUpdate(PlayerPartnerBufferExecCompleted);
}

static void PlayerPartnerHandleStatusAnimation(void) {
   BtlController_HandleStatusAnimation(PlayerPartnerBufferExecCompleted);
}
...
static void PlayerPartnerHandleHitAnimation(void) {
   BtlController_HandleHitAnimation(PlayerPartnerBufferExecCompleted);
}
...
static void PlayerPartnerHandleBattleAnimation(void) {
   BtlController_HandleBattleAnimation(PlayerPartnerBufferExecCompleted, TRUE);
}
...
static void PlayerPartnerHandleReportStatChange(void) {
   BtlController_HandleReportStatChange(PlayerPartnerBufferExecCompleted);
}
