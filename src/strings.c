...
const u8 gText_PkmnHoldingItemCantHoldMail[] = _("This POKéMON is holding an\nitem. {PRONOUN_VAR_1}{PRONOUN_FORM_CAP_SUBJECT} cannot hold MAIL.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnCuredOfPoison[] = _("{STR_VAR_1} was cured of {PRONOUN_VAR_1}{PRONOUN_FORM_POSSESSIVE}\npoisoning.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnSnappedOutOfConfusion[] = _("{STR_VAR_1} snapped out of {PRONOUN_VAR_1}{PRONOUN_FORM_POSSESSIVE}\nconfusion.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnGotOverInfatuation[] = _("{STR_VAR_1} got over {PRONOUN_VAR_1}{PRONOUN_FORM_POSSESSIVE}\ninfatuation.{PAUSE_UNTIL_PRESS}");
