...
export default class CustomEm_EasyChat_CombinePokemonGroups extends AbstractDataFormatTranslator {
   ...
   translateInstance(src, dst) {
      ...
      if (group != 21) { // EC_GROUP_POKEMON_NATIONAL
         return;
      }
      group = 0; // EC_GROUP_POKEMON
