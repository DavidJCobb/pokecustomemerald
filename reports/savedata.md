...
This project uses an automatically-generated savedata format wherein savedata is "bitpacked" to optimize for storage space. The vanilla savedata format consumes **96.09%** of the available space, leaving 2172 bytes to spare. The bitpacked format consumes **86.46%** of that space, while wasting **0.46%** of the remaining space due to technical limitations, thereby leaving 7268 bytes to spare.
